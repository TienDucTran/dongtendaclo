...
const footerLinks = {
  ...
  contact: [
    ...
    { name: 'mvvgdd@gmail.com', href: 'mailto:mvvgdd@gmail.com' },
  ],
};
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li className="flex items-center gap-2">
                ...
                <a href="tel:0373778171" className="text-sm text-gray-400 hover:text-white transition-colors">
              ...
              <li className="flex items-center gap-2">
                ...
                <a href="mailto:mvvgdd@gmail.com" className="text-sm text-gray-400 hover:text-white transition-colors">
                  mvvgdd@gmail.com
                </a>
              </li>
            </ul>
